...
class Ordens_servicos extends CI_Controller
{
    ...
    public function pdf($ordem_servico_id = NULL)
    {
        if (!$ordem_servico_id || !$this->core_model->get_by_id('ordens_servicos', array('ordem_servico_id' => $ordem_servico_id))) {
            ...
            $html .= '<head>';
            $html .= '<title>' . $empresa->sistema_nome_fantasia . ' | Impressão de OS</title>';
            $html .= '</head>';
            ...
            $html .= '<h4 align="center">
                ...
                ' . 'Celular:&nbsp;' . $empresa->sistema_telefone_movel . ' </br>
            ...
            $html .= '<table width="100%" style="border-top: solid #ddd 1px">';
            ...
            $html .= '<td style="border-top: solid #ddd 1px"><strong>Valor total da ordem</strong></td>';
            $html .= '<td style="border-top: solid #ddd 1px"><strong> ' . $valor_final_os->os_valor_total . ' </strong></td>';

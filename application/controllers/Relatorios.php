	...
	public function vendas()
	{
		...
		if ($data_inicial) {
			...
			if ($this->vendas_model->gerar_relatorio_vendas($data_inicial, $data_final)) {
				...
				$html .= '<td style="padding-top: 20px">' . 'R$&nbsp;' . $valor_final_vendas->venda_valor_total . '</td>';
	...
	public function os()
	{
		...
		if ($data_inicial) {
			...
			if ($this->ordem_servico_model->gerar_relatorio_os($data_inicial, $data_final)) {
				...
				$html .= '<td style="padding-top: 20px"><strong>Valor final</strong></td>';
				$html .= '<td style="padding-top: 20px">' . 'R$&nbsp;' . $valor_final_os->ordem_servico_valor_total . '</td>';
		...
		if ($contas == 'vencidas' || $contas == 'pagas' || $contas == 'receber') {
			...
			if ($contas == 'vencidas') {
                ...
                ' . 'CEP: ' . $empresa->sistema_cep . ', &nbsp;' . $empresa->sistema_cidade . ', &nbsp;' . $empresa->sistema_estado . '<br/>
					...
					$html .= '<td style="padding-top: 20px"><strong>Valor final</strong></td>';
					$html .= '<td style="padding-top: 20px">' . 'R$&nbsp;' . $valor_final_contas->conta_receber_valor_total . '</td>';
		...
		if ($contas == 'pagas' || $contas == 'vencidas' || $contas == 'a_pagar') {
			...
			if ($contas == 'vencidas') {
                ...
                ' . 'CEP: ' . $empresa->sistema_cep . ', &nbsp;' . $empresa->sistema_cidade . ', &nbsp;' . $empresa->sistema_estado . '<br/>
					...
					$html .= '<td style="padding-top: 20px"><strong>Valor final</strong></td>';
					$html .= '<td style="padding-top: 20px">' . 'R$&nbsp;' . $valor_final_contas->conta_pagar_valor_total . '</td>';

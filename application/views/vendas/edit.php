            ...
            <div class="card-body">
                <form class="user" action="" id="form" name="form_edit" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <fieldset id="vendas" class="mt-4 border p-2">
                        ...
                        <legend class="small"><i class="fas fa-shopping-cart"></i>&nbsp;&nbsp;Escolha os produtos</legend>

                        <div class="form-group row">
                            <div class="form-outline mb-4 col-md-12">
                                <input id="buscar_produtos" type="search" class="form-control " id="datatable-search-input" placeholder="Que produto você está buscando?">
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table id="table_produtos" class="table">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th class="" style="width: 50%">Produto</th>
                                        <th class="text-center pr-2" style="width: 15%">Valor unitário</th>
                                        <th class="text-center" style="width: 8%">Qtd</th>
                                        <th class="" style="width: 10%">% Desc</th>
                                ...
                                <tbody id="lista_produtos" class="item">
                                    ...
                                    <?php foreach ($venda_produtos as $venda_produto) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><input title="Descrição do produto" type="text" name="produto_descricao[]" value="<?php echo $venda_produto->produto_descricao; ?>" class="produto_descricao form-control  input-sm" data-cell="B<?php echo $i; ?>" readonly></td>
                                            <td><input title="Valor unitário do produto" name="produto_preco_venda[]" value="<?php echo $venda_produto->venda_produto_valor_unitario; ?>" class="form-control  input-sm text-right money pr-1" data-cell="C<?php echo $i; ?>" data-format="R$ 0,0.00" readonly></td>
                                            <td><input title="Digite a quantidade apenas em número inteiros" type="text" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" name="produto_quantidade[]" value="<?php echo $venda_produto->venda_produto_quantidade; ?>" class="qty form-control  text-center" data-cell="D<?php echo $i; ?>" data-format="0[.]00" required></td>
                                            <td><input title="Insira o desconto" name="produto_desconto[]" class="form-control  input-sm text-right" value="<?php echo $venda_produto->venda_produto_desconto; ?>" data-cell="E<?php echo $i; ?>" data-format="0,0[.]00 %" required></td>
                                            <td><input title="Valor total do produto selecionado" name="produto_item_total[]" value="<?php echo $venda_produto->venda_produto_valor_total; ?>" class="form-control  input-sm text-right pr-1" data-cell="F<?php echo $i; ?>" data-format="R$ 0,0.00" data-formula="D<?php echo $i; ?>*(C<?php echo $i; ?>-(C<?php echo $i; ?>*E<?php echo $i; ?>))" readonly></td>
                                ...
                                <tfoot>
                                    <tr class="">
                                        ...
                                        <td class="text-right border-0">
                                            <input type="text" name="venda_valor_desconto" class="form-control  text-right pr-1" data-format="$ 0,0.00" data-cell="L1" data-formula="SUM(H1:H5)" readonly="">
                                        </td>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="text-right border-0">
                                            <input type="text" name="venda_valor_total" class="form-control  text-right pr-1" data-format="$ 0,0.00" data-cell="G2" data-formula="SUM(F1:F5)" readonly="">
                                        </td>
                                        <td class="border-0">&nbsp;</td>
                                    </tr>
                                </tfoot>
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <legend class="small"><i class="far fa-money-bill-alt"></i>&nbsp;&nbsp;Dados da venda</legend>
                    ...
                    <div class="mt-3">
                        <button class="btn btn-success btn-sm mr-2" id="btn-cadastrar-venda" form="form" <?php echo ($desabilitar == TRUE ? 'disabled' : ''); ?>><?php echo ($desabilitar == TRUE ? 'Encerrada' : 'Salvar'); ?></button>
                        <a href="<?php echo base_url('vendas'); ?>" class="btn btn-primary btn-sm">Voltar</a>
                    </div>

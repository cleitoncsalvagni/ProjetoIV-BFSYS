...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form class="user" action="" id="form" name="form_novo" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-success btn-sm mr-2" id="btn-cadastrar-venda" form="form">Cadastrar</button>

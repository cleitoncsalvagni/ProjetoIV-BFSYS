                            ...
                            <?php foreach ($fornecedores as $fornecedor) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class='text-center'>
                                        ...
                                        <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#user-<?php echo $fornecedor->fornecedor_id ?>" class="btn btn-outline-danger rounded btn-sm"><i class="fas fa-trash"></i></i></a>
                                    </td>
                                </tr>

	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<a href='<?php echo base_url('pagar/novo') ?>' title='Cadastrar nova conta' class='btn btn-success rounded btn-sm '><i class="fas fa-plus"></i>&nbsp; Nova conta</a>
			</div>
			<div class="card-body">
							...
							<?php foreach ($contas_pagar as $conta) : ?>
								...
								<tr>
									...
									<td class='text-center'>
										<a title="Editar" href="<?php echo base_url('pagar/edit/' . $conta->conta_pagar_id) ?>" class="btn btn-outline-primary rounded btn-sm"><i class="fas fa-user-edit"></i></a>
										<a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#user-<?php echo $conta->conta_pagar_id ?>" class="btn btn-outline-danger rounded btn-sm"><i class="fas fa-user-times"></i></i></a>
									</td>
								</tr>

								<div class="modal fade" id="user-<?php echo $conta->conta_pagar_id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<a class="btn btn-danger btn-sm" href="<?php echo base_url('pagar/del/' . $conta->conta_pagar_id) ?>">Deletar</a>
											</div>
										</div>
									</div>
								</div>

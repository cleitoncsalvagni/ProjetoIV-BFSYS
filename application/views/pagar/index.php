							...
							<?php foreach ($contas_pagar as $conta) : ?>
								...
								<tr>
									...
									<td class='text-center'>
										<a title="Editar" href="<?php echo base_url('pagar/edit/' . $conta->conta_pagar_id) ?>" class="btn btn-outline-primary rounded btn-sm"><i class="fas fa-pen"></i></a>
										<a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#user-<?php echo $conta->conta_pagar_id ?>" class="btn btn-outline-danger rounded btn-sm"><i class="fas fa-trash"></i></i></a>
									</td>
								</tr>

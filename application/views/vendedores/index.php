    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a href='<?php echo base_url('vendedores/novo') ?>' title='Cadastrar novo vendedor' class='btn btn-success rounded btn-sm '><i class="fas fa-plus"></i>&nbsp; Novo vendedor</a>
            </div>
            <div class="card-body">
                            ...
                            <?php foreach ($vendedores as $vendedor) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class='text-center'>
                                        ...
                                        <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#user-<?php echo $vendedor->vendedor_id ?>" class="btn btn-outline-danger rounded btn-sm"><i class="fas fa-trash"></i></i></a>
                                    </td>
                                </tr>

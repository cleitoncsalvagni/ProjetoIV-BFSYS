    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a href='<?php echo base_url('categorias/novo') ?>' title='Cadastrar nova categoria' class='btn btn-success rounded btn-sm '><i class="fas fa-plus"></i>&nbsp; Nova categoria</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($categorias as $categoria) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class='text-center pr-4'><?php echo ($categoria->categoria_ativa ? '<span class="badge badge-success btn-sm">Sim</span>' : '<span class="badge badge-danger btn-sm">Não</span>') ?></td>
                                    <td class='text-center'>
                                        <a title="Editar" href="<?php echo base_url('categorias/edit/' . $categoria->categoria_id) ?>" class="btn btn-outline-primary rounded btn-sm"><i class="fas fa-pen"></i></a>
                                        <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#user-<?php echo $categoria->categoria_id ?>" class="btn btn-outline-danger rounded btn-sm"><i class="fas fa-trash"></i></i></a>
                                    </td>
                                </tr>
